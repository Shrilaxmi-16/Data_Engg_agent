...
CREATE TABLE tpcds.customer (
    ...
    c_current_cdemo_sk INTEGER REFERENCES tpcds.customer_demographics(cd_demo_sk),
    c_current_hdemo_sk INTEGER REFERENCES tpcds.household_demographics(hd_demo_sk),
    c_current_addr_sk INTEGER REFERENCES tpcds.customer_address(ca_address_sk),
